...
- **4 種法器**：塑膠拖鞋 (-1)、五吋長針 (-2)、九節鞭 (-3)、桃木劍 (-5)，每種音效不同，傷害值直接累積影響紙人退化階段

### 📈 進階系統
- **5 階段紙人退化**：完好 → 受損 → 重傷 → 殘破 → 潰散，外觀裂痕、血跡、表情逐漸加劇
- **怒氣條**：集滿 100 點後可手動按下「怒氣爆發」按鈕，觸發桃木劍連環五擊 + 多重咒語齊發，爆發後怒氣歸零
- **蓋印系統**：累積傷害達 30 後祭壇自動蓋上「已打 · 驚蟄祭壇印」紅印
- **驚蟄大禮成儀式**：累積傷害達 50 後觸發祝福彈窗，含「小人遠離我，貴人近身來」祝詞
...
- **無障礙**：語意化 HTML、ARIA 標籤、祭壇支援 Enter/Space 鍵操作、輸入框 Enter 提交
- **響應式**：手機到桌面全寬皆適配
...
MIT License - 詳見 [LICENSE](LICENSE)。歡迎自由 fork、修改、部署自己的版本。
